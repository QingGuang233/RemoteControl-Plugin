 ...
 *
 */
public class ClientOutputExceptionHandler extends AbstractClientExceptionHandler{
	 ...
	 */
	public ClientOutputExceptionHandler(Logger logger) {
		this.logger = logger;
	}
	...
	public void handle(IOException exc) {
		if(client != null && client.isRunning()) {
			...
			logger.warning("有一个客户端因数据输出异常已断开连接");
